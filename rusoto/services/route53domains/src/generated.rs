...
impl<T: ?Sized + Route53Domains> Route53Domains for ::std::rc::Rc<T> {
    /// <p>This operation checks the availability of one domain name. Note that if the availability status of a domain is pending, you must submit another request to determine the availability of the domain name.</p>
    fn check_domain_availability(
        &self,
        input: CheckDomainAvailabilityRequest,
    ) -> RusotoFuture<CheckDomainAvailabilityResponse, CheckDomainAvailabilityError> {
        Route53Domains::check_domain_availability(&(**self), input)
    }
    ...
    fn check_domain_transferability(
        ...
        Route53Domains::check_domain_transferability(&(**self), input)
    }
    ...
    fn delete_tags_for_domain(
        ...
        Route53Domains::delete_tags_for_domain(&(**self), input)
    }
    ...
    fn disable_domain_auto_renew(
        ...
        Route53Domains::disable_domain_auto_renew(&(**self), input)
    }
    ...
    fn disable_domain_transfer_lock(
        ...
        Route53Domains::disable_domain_transfer_lock(&(**self), input)
    }
    ...
    fn enable_domain_auto_renew(
        ...
        Route53Domains::enable_domain_auto_renew(&(**self), input)
    }
    ...
    fn enable_domain_transfer_lock(
        ...
        Route53Domains::enable_domain_transfer_lock(&(**self), input)
    }
    ...
    fn get_contact_reachability_status(
        ...
        Route53Domains::get_contact_reachability_status(&(**self), input)
    }
    ...
    fn get_domain_detail(
        ...
        Route53Domains::get_domain_detail(&(**self), input)
    }
    ...
    fn get_domain_suggestions(
        ...
        Route53Domains::get_domain_suggestions(&(**self), input)
    }
    ...
    fn get_operation_detail(
        ...
        Route53Domains::get_operation_detail(&(**self), input)
    }
    ...
    fn list_domains(
        ...
        Route53Domains::list_domains(&(**self), input)
    }
    ...
    fn list_operations(
        ...
        Route53Domains::list_operations(&(**self), input)
    }
    ...
    fn list_tags_for_domain(
        ...
        Route53Domains::list_tags_for_domain(&(**self), input)
    }
    ...
    fn register_domain(
        ...
        Route53Domains::register_domain(&(**self), input)
    }
    ...
    fn renew_domain(
        ...
        Route53Domains::renew_domain(&(**self), input)
    }
    ...
    {
        Route53Domains::resend_contact_reachability_email(&(**self), input)
    }
    ...
    fn retrieve_domain_auth_code(
        ...
        Route53Domains::retrieve_domain_auth_code(&(**self), input)
    }
    ...
    fn transfer_domain(
        ...
        Route53Domains::transfer_domain(&(**self), input)
    }
    ...
    fn update_domain_contact(
        ...
        Route53Domains::update_domain_contact(&(**self), input)
    }
    ...
    fn update_domain_contact_privacy(
        ...
        Route53Domains::update_domain_contact_privacy(&(**self), input)
    }
    ...
    fn update_domain_nameservers(
        ...
        Route53Domains::update_domain_nameservers(&(**self), input)
    }
    ...
    fn update_tags_for_domain(
        ...
        Route53Domains::update_tags_for_domain(&(**self), input)
    }
    ...
    fn view_billing(
        ...
        Route53Domains::view_billing(&(**self), input)
    }
}
