...
impl<T: ?Sized + CognitoSync> CognitoSync for ::std::rc::Rc<T> {
    /// <p>Initiates a bulk publish of all existing datasets for an Identity Pool to the configured stream. Customers are limited to one successful bulk publish per 24 hours. Bulk publish is an asynchronous request, customers can see the status of the request via the GetBulkPublishDetails operation.</p> <p>This API can only be called with developer credentials. You cannot call this API with the temporary user credentials provided by Cognito Identity.</p>
    fn bulk_publish(
        &self,
        input: BulkPublishRequest,
    ) -> RusotoFuture<BulkPublishResponse, BulkPublishError> {
        CognitoSync::bulk_publish(&(**self), input)
    }
    ...
    fn delete_dataset(
        ...
        CognitoSync::delete_dataset(&(**self), input)
    }
    ...
    fn describe_dataset(
        ...
        CognitoSync::describe_dataset(&(**self), input)
    }
    ...
    fn describe_identity_pool_usage(
        ...
        CognitoSync::describe_identity_pool_usage(&(**self), input)
    }
    ...
    fn describe_identity_usage(
        ...
        CognitoSync::describe_identity_usage(&(**self), input)
    }
    ...
    fn get_bulk_publish_details(
        ...
        CognitoSync::get_bulk_publish_details(&(**self), input)
    }
    ...
    fn get_cognito_events(
        ...
        CognitoSync::get_cognito_events(&(**self), input)
    }
    ...
    fn get_identity_pool_configuration(
        ...
        CognitoSync::get_identity_pool_configuration(&(**self), input)
    }
    ...
    fn list_datasets(
        ...
        CognitoSync::list_datasets(&(**self), input)
    }
    ...
    fn list_identity_pool_usage(
        ...
        CognitoSync::list_identity_pool_usage(&(**self), input)
    }
    ...
    fn list_records(
        ...
        CognitoSync::list_records(&(**self), input)
    }
    ...
    fn register_device(
        ...
        CognitoSync::register_device(&(**self), input)
    }
    ...
    fn set_cognito_events(
        ...
        CognitoSync::set_cognito_events(&(**self), input)
    }
    ...
    fn set_identity_pool_configuration(
        ...
        CognitoSync::set_identity_pool_configuration(&(**self), input)
    }
    ...
    fn subscribe_to_dataset(
        ...
        CognitoSync::subscribe_to_dataset(&(**self), input)
    }
    ...
    fn unsubscribe_from_dataset(
        ...
        CognitoSync::unsubscribe_from_dataset(&(**self), input)
    }
    ...
    fn update_records(
        ...
        CognitoSync::update_records(&(**self), input)
    }
}
