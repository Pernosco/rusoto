...
impl<T: ?Sized + CloudTrail> CloudTrail for ::std::rc::Rc<T> {
    /// <p>Adds one or more tags to a trail, up to a limit of 50. Tags must be unique per trail. Overwrites an existing tag's value when a new value is specified for an existing tag key. If you specify a key without a value, the tag will be created with the specified key and a value of null. You can tag a trail that applies to all regions only from the region in which the trail was created (that is, from its home region).</p>
    fn add_tags(&self, input: AddTagsRequest) -> RusotoFuture<AddTagsResponse, AddTagsError> {
        CloudTrail::add_tags(&(**self), input)
    }
    ...
    fn create_trail(
        ...
        CloudTrail::create_trail(&(**self), input)
    }
    ...
    fn delete_trail(
        ...
        CloudTrail::delete_trail(&(**self), input)
    }
    ...
    fn describe_trails(
        ...
        CloudTrail::describe_trails(&(**self), input)
    }
    ...
    fn get_event_selectors(
        ...
        CloudTrail::get_event_selectors(&(**self), input)
    }
    ...
    fn get_trail_status(
        ...
        CloudTrail::get_trail_status(&(**self), input)
    }
    ...
    fn list_public_keys(
        ...
        CloudTrail::list_public_keys(&(**self), input)
    }

    /// <p>Lists the tags for the trail in the current region.</p>
    fn list_tags(&self, input: ListTagsRequest) -> RusotoFuture<ListTagsResponse, ListTagsError> {
        CloudTrail::list_tags(&(**self), input)
    }
    ...
    fn lookup_events(
        ...
        CloudTrail::lookup_events(&(**self), input)
    }
    ...
    fn put_event_selectors(
        ...
        CloudTrail::put_event_selectors(&(**self), input)
    }
    ...
    fn remove_tags(
        ...
        CloudTrail::remove_tags(&(**self), input)
    }
    ...
    fn start_logging(
        ...
        CloudTrail::start_logging(&(**self), input)
    }
    ...
    fn stop_logging(
        ...
        CloudTrail::stop_logging(&(**self), input)
    }
    ...
    fn update_trail(
        ...
        CloudTrail::update_trail(&(**self), input)
    }
}
