...
impl<T: ?Sized + StorageGateway> StorageGateway for ::std::rc::Rc<T> {
    /// <p><p>Activates the gateway you previously deployed on your host. In the activation process, you specify information such as the region you want to use for storing snapshots or tapes, the time zone for scheduled snapshots the gateway snapshot schedule window, an activation key, and a name for your gateway. The activation process also associates your gateway with your account; for more information, see <a>UpdateGatewayInformation</a>.</p> <note> <p>You must turn on the gateway VM before you can activate your gateway.</p> </note></p>
    fn activate_gateway(
        &self,
        input: ActivateGatewayInput,
    ) -> RusotoFuture<ActivateGatewayOutput, ActivateGatewayError> {
        StorageGateway::activate_gateway(&(**self), input)
    }

    /// <p>Configures one or more gateway local disks as cache for a gateway. This operation is only supported in the cached volume, tape and file gateway type (see <a href="http://docs.aws.amazon.com/storagegateway/latest/userguide/StorageGatewayConcepts.html">Storage Gateway Concepts</a>).</p> <p>In the request, you specify the gateway Amazon Resource Name (ARN) to which you want to add cache, and one or more disk IDs that you want to configure as cache.</p>
    fn add_cache(&self, input: AddCacheInput) -> RusotoFuture<AddCacheOutput, AddCacheError> {
        StorageGateway::add_cache(&(**self), input)
    }
    ...
    fn add_tags_to_resource(
        ...
        StorageGateway::add_tags_to_resource(&(**self), input)
    }
    ...
    fn add_upload_buffer(
        ...
        StorageGateway::add_upload_buffer(&(**self), input)
    }
    ...
    fn add_working_storage(
        ...
        StorageGateway::add_working_storage(&(**self), input)
    }
    ...
    fn cancel_archival(
        ...
        StorageGateway::cancel_archival(&(**self), input)
    }
    ...
    fn cancel_retrieval(
        ...
        StorageGateway::cancel_retrieval(&(**self), input)
    }
    ...
    fn create_cachedi_scsi_volume(
        ...
        StorageGateway::create_cachedi_scsi_volume(&(**self), input)
    }
    ...
    fn create_nfs_file_share(
        ...
        StorageGateway::create_nfs_file_share(&(**self), input)
    }
    ...
    fn create_smb_file_share(
        ...
        StorageGateway::create_smb_file_share(&(**self), input)
    }
    ...
    fn create_snapshot(
        ...
        StorageGateway::create_snapshot(&(**self), input)
    }
    ...
    fn create_snapshot_from_volume_recovery_point(
        ...
        CreateSnapshotFromVolumeRecoveryPointError,
    > {
        StorageGateway::create_snapshot_from_volume_recovery_point(&(**self), input)
    }
    ...
    fn create_storedi_scsi_volume(
        ...
        StorageGateway::create_storedi_scsi_volume(&(**self), input)
    }
    ...
    fn create_tape_with_barcode(
        ...
        StorageGateway::create_tape_with_barcode(&(**self), input)
    }
    ...
    fn create_tapes(
        ...
        StorageGateway::create_tapes(&(**self), input)
    }
    ...
    fn delete_bandwidth_rate_limit(
        ...
        StorageGateway::delete_bandwidth_rate_limit(&(**self), input)
    }
    ...
    fn delete_chap_credentials(
        ...
        StorageGateway::delete_chap_credentials(&(**self), input)
    }
    ...
    fn delete_file_share(
        ...
        StorageGateway::delete_file_share(&(**self), input)
    }
    ...
    fn delete_gateway(
        ...
        StorageGateway::delete_gateway(&(**self), input)
    }
    ...
    fn delete_snapshot_schedule(
        ...
        StorageGateway::delete_snapshot_schedule(&(**self), input)
    }
    ...
    fn delete_tape(
        ...
        StorageGateway::delete_tape(&(**self), input)
    }
    ...
    fn delete_tape_archive(
        ...
        StorageGateway::delete_tape_archive(&(**self), input)
    }
    ...
    fn delete_volume(
        ...
        StorageGateway::delete_volume(&(**self), input)
    }
    ...
    fn describe_bandwidth_rate_limit(
        ...
        StorageGateway::describe_bandwidth_rate_limit(&(**self), input)
    }
    ...
    fn describe_cache(
        ...
        StorageGateway::describe_cache(&(**self), input)
    }
    ...
    fn describe_cachedi_scsi_volumes(
        ...
        StorageGateway::describe_cachedi_scsi_volumes(&(**self), input)
    }
    ...
    fn describe_chap_credentials(
        ...
        StorageGateway::describe_chap_credentials(&(**self), input)
    }
    ...
    fn describe_gateway_information(
        ...
        StorageGateway::describe_gateway_information(&(**self), input)
    }
    ...
    fn describe_maintenance_start_time(
        ...
        StorageGateway::describe_maintenance_start_time(&(**self), input)
    }
    ...
    fn describe_nfs_file_shares(
        ...
        StorageGateway::describe_nfs_file_shares(&(**self), input)
    }
    ...
    fn describe_smb_file_shares(
        ...
        StorageGateway::describe_smb_file_shares(&(**self), input)
    }
    ...
    fn describe_smb_settings(
        ...
        StorageGateway::describe_smb_settings(&(**self), input)
    }
    ...
    fn describe_snapshot_schedule(
        ...
        StorageGateway::describe_snapshot_schedule(&(**self), input)
    }
    ...
    fn describe_storedi_scsi_volumes(
        ...
        StorageGateway::describe_storedi_scsi_volumes(&(**self), input)
    }
    ...
    fn describe_tape_archives(
        ...
        StorageGateway::describe_tape_archives(&(**self), input)
    }
    ...
    fn describe_tape_recovery_points(
        ...
        StorageGateway::describe_tape_recovery_points(&(**self), input)
    }
    ...
    fn describe_tapes(
        ...
        StorageGateway::describe_tapes(&(**self), input)
    }
    ...
    fn describe_upload_buffer(
        ...
        StorageGateway::describe_upload_buffer(&(**self), input)
    }
    ...
    fn describe_vtl_devices(
        ...
        StorageGateway::describe_vtl_devices(&(**self), input)
    }
    ...
    fn describe_working_storage(
        ...
        StorageGateway::describe_working_storage(&(**self), input)
    }
    ...
    fn disable_gateway(
        ...
        StorageGateway::disable_gateway(&(**self), input)
    }
    ...
    fn join_domain(
        ...
        StorageGateway::join_domain(&(**self), input)
    }
    ...
    fn list_file_shares(
        ...
        StorageGateway::list_file_shares(&(**self), input)
    }
    ...
    fn list_gateways(
        ...
        StorageGateway::list_gateways(&(**self), input)
    }
    ...
    fn list_local_disks(
        ...
        StorageGateway::list_local_disks(&(**self), input)
    }
    ...
    fn list_tags_for_resource(
        ...
        StorageGateway::list_tags_for_resource(&(**self), input)
    }

    /// <p>Lists virtual tapes in your virtual tape library (VTL) and your virtual tape shelf (VTS). You specify the tapes to list by specifying one or more tape Amazon Resource Names (ARNs). If you don't specify a tape ARN, the operation lists all virtual tapes in both your VTL and VTS.</p> <p>This operation supports pagination. By default, the operation returns a maximum of up to 100 tapes. You can optionally specify the <code>Limit</code> parameter in the body to limit the number of tapes in the response. If the number of tapes returned in the response is truncated, the response includes a <code>Marker</code> element that you can use in your subsequent request to retrieve the next set of tapes. This operation is only supported in the tape gateway type.</p>
    fn list_tapes(&self, input: ListTapesInput) -> RusotoFuture<ListTapesOutput, ListTapesError> {
        StorageGateway::list_tapes(&(**self), input)
    }
    ...
    fn list_volume_initiators(
        ...
        StorageGateway::list_volume_initiators(&(**self), input)
    }
    ...
    fn list_volume_recovery_points(
        ...
        StorageGateway::list_volume_recovery_points(&(**self), input)
    }
    ...
    fn list_volumes(
        ...
        StorageGateway::list_volumes(&(**self), input)
    }
    ...
    fn notify_when_uploaded(
        ...
        StorageGateway::notify_when_uploaded(&(**self), input)
    }
    ...
    fn refresh_cache(
        ...
        StorageGateway::refresh_cache(&(**self), input)
    }
    ...
    fn remove_tags_from_resource(
        ...
        StorageGateway::remove_tags_from_resource(&(**self), input)
    }
    ...
    fn reset_cache(
        ...
        StorageGateway::reset_cache(&(**self), input)
    }
    ...
    fn retrieve_tape_archive(
        ...
        StorageGateway::retrieve_tape_archive(&(**self), input)
    }
    ...
    fn retrieve_tape_recovery_point(
        ...
        StorageGateway::retrieve_tape_recovery_point(&(**self), input)
    }
    ...
    fn set_local_console_password(
        ...
        StorageGateway::set_local_console_password(&(**self), input)
    }
    ...
    fn set_smb_guest_password(
        ...
        StorageGateway::set_smb_guest_password(&(**self), input)
    }
    ...
    fn shutdown_gateway(
        ...
        StorageGateway::shutdown_gateway(&(**self), input)
    }
    ...
    fn start_gateway(
        ...
        StorageGateway::start_gateway(&(**self), input)
    }
    ...
    fn update_bandwidth_rate_limit(
        ...
        StorageGateway::update_bandwidth_rate_limit(&(**self), input)
    }
    ...
    fn update_chap_credentials(
        ...
        StorageGateway::update_chap_credentials(&(**self), input)
    }
    ...
    fn update_gateway_information(
        ...
        StorageGateway::update_gateway_information(&(**self), input)
    }
    ...
    fn update_gateway_software_now(
        ...
        StorageGateway::update_gateway_software_now(&(**self), input)
    }
    ...
    fn update_maintenance_start_time(
        ...
        StorageGateway::update_maintenance_start_time(&(**self), input)
    }
    ...
    fn update_nfs_file_share(
        ...
        StorageGateway::update_nfs_file_share(&(**self), input)
    }
    ...
    fn update_smb_file_share(
        ...
        StorageGateway::update_smb_file_share(&(**self), input)
    }
    ...
    fn update_snapshot_schedule(
        ...
        StorageGateway::update_snapshot_schedule(&(**self), input)
    }
    ...
    fn update_vtl_device_type(
        ...
        StorageGateway::update_vtl_device_type(&(**self), input)
    }
}
