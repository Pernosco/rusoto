...
pub struct DisassociateWebACLRequest {
    /// <p>The ARN (Amazon Resource Name) of the resource from which the web ACL is being removed.</p>
    #[serde(rename = "ResourceArn")]
    pub resource_arn: String,
}
...
impl<T: ?Sized + WAFRegional> WAFRegional for ::std::rc::Rc<T> {
    /// <p>Associates a web ACL with a resource.</p>
    fn associate_web_acl(
        &self,
        input: AssociateWebACLRequest,
    ) -> RusotoFuture<AssociateWebACLResponse, AssociateWebACLError> {
        WAFRegional::associate_web_acl(&(**self), input)
    }
    ...
    fn create_byte_match_set(
        ...
        WAFRegional::create_byte_match_set(&(**self), input)
    }
    ...
    fn create_geo_match_set(
        ...
        WAFRegional::create_geo_match_set(&(**self), input)
    }
    ...
    fn create_ip_set(
        ...
        WAFRegional::create_ip_set(&(**self), input)
    }
    ...
    fn create_rate_based_rule(
        ...
        WAFRegional::create_rate_based_rule(&(**self), input)
    }
    ...
    fn create_regex_match_set(
        ...
        WAFRegional::create_regex_match_set(&(**self), input)
    }
    ...
    fn create_regex_pattern_set(
        ...
        WAFRegional::create_regex_pattern_set(&(**self), input)
    }
    ...
    fn create_rule(
        ...
        WAFRegional::create_rule(&(**self), input)
    }
    ...
    fn create_rule_group(
        ...
        WAFRegional::create_rule_group(&(**self), input)
    }
    ...
    fn create_size_constraint_set(
        ...
        WAFRegional::create_size_constraint_set(&(**self), input)
    }
    ...
    fn create_sql_injection_match_set(
        ...
        WAFRegional::create_sql_injection_match_set(&(**self), input)
    }
    ...
    fn create_web_acl(
        ...
        WAFRegional::create_web_acl(&(**self), input)
    }
    ...
    fn create_xss_match_set(
        ...
        WAFRegional::create_xss_match_set(&(**self), input)
    }
    ...
    fn delete_byte_match_set(
        ...
        WAFRegional::delete_byte_match_set(&(**self), input)
    }
    ...
    fn delete_geo_match_set(
        ...
        WAFRegional::delete_geo_match_set(&(**self), input)
    }
    ...
    fn delete_ip_set(
        ...
        WAFRegional::delete_ip_set(&(**self), input)
    }
    ...
    fn delete_permission_policy(
        ...
        WAFRegional::delete_permission_policy(&(**self), input)
    }
    ...
    fn delete_rate_based_rule(
        ...
        WAFRegional::delete_rate_based_rule(&(**self), input)
    }
    ...
    fn delete_regex_match_set(
        ...
        WAFRegional::delete_regex_match_set(&(**self), input)
    }
    ...
    fn delete_regex_pattern_set(
        ...
        WAFRegional::delete_regex_pattern_set(&(**self), input)
    }
    ...
    fn delete_rule(
        ...
        WAFRegional::delete_rule(&(**self), input)
    }
    ...
    fn delete_rule_group(
        ...
        WAFRegional::delete_rule_group(&(**self), input)
    }
    ...
    fn delete_size_constraint_set(
        ...
        WAFRegional::delete_size_constraint_set(&(**self), input)
    }
    ...
    fn delete_sql_injection_match_set(
        ...
        WAFRegional::delete_sql_injection_match_set(&(**self), input)
    }
    ...
    fn delete_web_acl(
        ...
        WAFRegional::delete_web_acl(&(**self), input)
    }
    ...
    fn delete_xss_match_set(
        ...
        WAFRegional::delete_xss_match_set(&(**self), input)
    }
    ...
    fn disassociate_web_acl(
        ...
        WAFRegional::disassociate_web_acl(&(**self), input)
    }
    ...
    fn get_byte_match_set(
        ...
        WAFRegional::get_byte_match_set(&(**self), input)
    }

    /// <p>When you want to create, update, or delete AWS WAF objects, get a change token and include the change token in the create, update, or delete request. Change tokens ensure that your application doesn't submit conflicting requests to AWS WAF.</p> <p>Each create, update, or delete request must use a unique change token. If your application submits a <code>GetChangeToken</code> request and then submits a second <code>GetChangeToken</code> request before submitting a create, update, or delete request, the second <code>GetChangeToken</code> request returns the same value as the first <code>GetChangeToken</code> request.</p> <p>When you use a change token in a create, update, or delete request, the status of the change token changes to <code>PENDING</code>, which indicates that AWS WAF is propagating the change to all AWS WAF servers. Use <code>GetChangeTokenStatus</code> to determine the status of your change token.</p>
    fn get_change_token(&self) -> RusotoFuture<GetChangeTokenResponse, GetChangeTokenError> {
        WAFRegional::get_change_token(&(**self))
    }
    ...
    fn get_change_token_status(
        ...
        WAFRegional::get_change_token_status(&(**self), input)
    }
    ...
    fn get_geo_match_set(
        ...
        WAFRegional::get_geo_match_set(&(**self), input)
    }

    /// <p>Returns the <a>IPSet</a> that is specified by <code>IPSetId</code>.</p>
    fn get_ip_set(&self, input: GetIPSetRequest) -> RusotoFuture<GetIPSetResponse, GetIPSetError> {
        WAFRegional::get_ip_set(&(**self), input)
    }
    ...
    fn get_permission_policy(
        ...
        WAFRegional::get_permission_policy(&(**self), input)
    }
    ...
    fn get_rate_based_rule(
        ...
        WAFRegional::get_rate_based_rule(&(**self), input)
    }
    ...
    fn get_rate_based_rule_managed_keys(
        ...
        WAFRegional::get_rate_based_rule_managed_keys(&(**self), input)
    }
    ...
    fn get_regex_match_set(
        ...
        WAFRegional::get_regex_match_set(&(**self), input)
    }
    ...
    fn get_regex_pattern_set(
        ...
        WAFRegional::get_regex_pattern_set(&(**self), input)
    }

    /// <p>Returns the <a>Rule</a> that is specified by the <code>RuleId</code> that you included in the <code>GetRule</code> request.</p>
    fn get_rule(&self, input: GetRuleRequest) -> RusotoFuture<GetRuleResponse, GetRuleError> {
        WAFRegional::get_rule(&(**self), input)
    }
    ...
    fn get_rule_group(
        ...
        WAFRegional::get_rule_group(&(**self), input)
    }
    ...
    fn get_sampled_requests(
        ...
        WAFRegional::get_sampled_requests(&(**self), input)
    }
    ...
    fn get_size_constraint_set(
        ...
        WAFRegional::get_size_constraint_set(&(**self), input)
    }
    ...
    fn get_sql_injection_match_set(
        ...
        WAFRegional::get_sql_injection_match_set(&(**self), input)
    }
    ...
    fn get_web_acl(
        ...
        WAFRegional::get_web_acl(&(**self), input)
    }
    ...
    fn get_web_acl_for_resource(
        ...
        WAFRegional::get_web_acl_for_resource(&(**self), input)
    }
    ...
    fn get_xss_match_set(
        ...
        WAFRegional::get_xss_match_set(&(**self), input)
    }
    ...
    {
        WAFRegional::list_activated_rules_in_rule_group(&(**self), input)
    }
    ...
    fn list_byte_match_sets(
        ...
        WAFRegional::list_byte_match_sets(&(**self), input)
    }
    ...
    fn list_geo_match_sets(
        ...
        WAFRegional::list_geo_match_sets(&(**self), input)
    }
    ...
    fn list_ip_sets(
        ...
        WAFRegional::list_ip_sets(&(**self), input)
    }
    ...
    fn list_rate_based_rules(
        ...
        WAFRegional::list_rate_based_rules(&(**self), input)
    }
    ...
    fn list_regex_match_sets(
        ...
        WAFRegional::list_regex_match_sets(&(**self), input)
    }
    ...
    fn list_regex_pattern_sets(
        ...
        WAFRegional::list_regex_pattern_sets(&(**self), input)
    }
    ...
    fn list_resources_for_web_acl(
        ...
        WAFRegional::list_resources_for_web_acl(&(**self), input)
    }
    ...
    fn list_rule_groups(
        ...
        WAFRegional::list_rule_groups(&(**self), input)
    }
    ...
    fn list_rules(
        ...
        WAFRegional::list_rules(&(**self), input)
    }
    ...
    fn list_size_constraint_sets(
        ...
        WAFRegional::list_size_constraint_sets(&(**self), input)
    }
    ...
    fn list_sql_injection_match_sets(
        ...
        WAFRegional::list_sql_injection_match_sets(&(**self), input)
    }
    ...
    fn list_subscribed_rule_groups(
        ...
        WAFRegional::list_subscribed_rule_groups(&(**self), input)
    }
    ...
    fn list_web_ac_ls(
        ...
        WAFRegional::list_web_ac_ls(&(**self), input)
    }
    ...
    fn list_xss_match_sets(
        ...
        WAFRegional::list_xss_match_sets(&(**self), input)
    }
    ...
    fn put_permission_policy(
        ...
        WAFRegional::put_permission_policy(&(**self), input)
    }
    ...
    fn update_byte_match_set(
        ...
        WAFRegional::update_byte_match_set(&(**self), input)
    }
    ...
    fn update_geo_match_set(
        ...
        WAFRegional::update_geo_match_set(&(**self), input)
    }
    ...
    fn update_ip_set(
        ...
        WAFRegional::update_ip_set(&(**self), input)
    }
    ...
    fn update_rate_based_rule(
        ...
        WAFRegional::update_rate_based_rule(&(**self), input)
    }
    ...
    fn update_regex_match_set(
        ...
        WAFRegional::update_regex_match_set(&(**self), input)
    }
    ...
    fn update_regex_pattern_set(
        ...
        WAFRegional::update_regex_pattern_set(&(**self), input)
    }
    ...
    fn update_rule(
        ...
        WAFRegional::update_rule(&(**self), input)
    }
    ...
    fn update_rule_group(
        ...
        WAFRegional::update_rule_group(&(**self), input)
    }
    ...
    fn update_size_constraint_set(
        ...
        WAFRegional::update_size_constraint_set(&(**self), input)
    }
    ...
    fn update_sql_injection_match_set(
        ...
        WAFRegional::update_sql_injection_match_set(&(**self), input)
    }
    ...
    fn update_web_acl(
        ...
        WAFRegional::update_web_acl(&(**self), input)
    }
    ...
    fn update_xss_match_set(
        ...
        WAFRegional::update_xss_match_set(&(**self), input)
    }
}
