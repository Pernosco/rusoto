...
impl<T: ?Sized + MechanicalTurk> MechanicalTurk for ::std::rc::Rc<T> {
    /// <p> The <code>AcceptQualificationRequest</code> operation approves a Worker's request for a Qualification. </p> <p> Only the owner of the Qualification type can grant a Qualification request for that type. </p> <p> A successful request for the <code>AcceptQualificationRequest</code> operation returns with no errors and an empty body. </p>
    fn accept_qualification_request(
        &self,
        input: AcceptQualificationRequestRequest,
    ) -> RusotoFuture<AcceptQualificationRequestResponse, AcceptQualificationRequestError> {
        MechanicalTurk::accept_qualification_request(&(**self), input)
    }
    ...
    fn approve_assignment(
        ...
        MechanicalTurk::approve_assignment(&(**self), input)
    }
    ...
    {
        MechanicalTurk::associate_qualification_with_worker(&(**self), input)
    }
    ...
    fn create_additional_assignments_for_hit(
        ...
        CreateAdditionalAssignmentsForHITError,
    > {
        MechanicalTurk::create_additional_assignments_for_hit(&(**self), input)
    }
    ...
    fn create_hit(
        ...
        MechanicalTurk::create_hit(&(**self), input)
    }
    ...
    fn create_hit_type(
        ...
        MechanicalTurk::create_hit_type(&(**self), input)
    }
    ...
    fn create_hit_with_hit_type(
        ...
        MechanicalTurk::create_hit_with_hit_type(&(**self), input)
    }
    ...
    fn create_qualification_type(
        ...
        MechanicalTurk::create_qualification_type(&(**self), input)
    }
    ...
    fn create_worker_block(
        ...
        MechanicalTurk::create_worker_block(&(**self), input)
    }
    ...
    fn delete_hit(
        ...
        MechanicalTurk::delete_hit(&(**self), input)
    }
    ...
    fn delete_qualification_type(
        ...
        MechanicalTurk::delete_qualification_type(&(**self), input)
    }
    ...
    fn delete_worker_block(
        ...
        MechanicalTurk::delete_worker_block(&(**self), input)
    }
    ...
    fn disassociate_qualification_from_worker(
        ...
        DisassociateQualificationFromWorkerError,
    > {
        MechanicalTurk::disassociate_qualification_from_worker(&(**self), input)
    }
    ...
    fn get_account_balance(
        ...
        MechanicalTurk::get_account_balance(&(**self))
    }
    ...
    fn get_assignment(
        ...
        MechanicalTurk::get_assignment(&(**self), input)
    }
    ...
    fn get_file_upload_url(
        ...
        MechanicalTurk::get_file_upload_url(&(**self), input)
    }

    /// <p> The <code>GetHIT</code> operation retrieves the details of the specified HIT. </p>
    fn get_hit(&self, input: GetHITRequest) -> RusotoFuture<GetHITResponse, GetHITError> {
        MechanicalTurk::get_hit(&(**self), input)
    }
    ...
    fn get_qualification_score(
        ...
        MechanicalTurk::get_qualification_score(&(**self), input)
    }
    ...
    fn get_qualification_type(
        ...
        MechanicalTurk::get_qualification_type(&(**self), input)
    }
    ...
    fn list_assignments_for_hit(
        ...
        MechanicalTurk::list_assignments_for_hit(&(**self), input)
    }
    ...
    fn list_bonus_payments(
        ...
        MechanicalTurk::list_bonus_payments(&(**self), input)
    }

    /// <p> The <code>ListHITs</code> operation returns all of a Requester's HITs. The operation returns HITs of any status, except for HITs that have been deleted of with the DeleteHIT operation or that have been auto-deleted. </p>
    fn list_hi_ts(&self, input: ListHITsRequest) -> RusotoFuture<ListHITsResponse, ListHITsError> {
        MechanicalTurk::list_hi_ts(&(**self), input)
    }
    ...
    fn list_hi_ts_for_qualification_type(
        ...
        MechanicalTurk::list_hi_ts_for_qualification_type(&(**self), input)
    }
    ...
    fn list_qualification_requests(
        ...
        MechanicalTurk::list_qualification_requests(&(**self), input)
    }
    ...
    fn list_qualification_types(
        ...
        MechanicalTurk::list_qualification_types(&(**self), input)
    }
    ...
    {
        MechanicalTurk::list_review_policy_results_for_hit(&(**self), input)
    }
    ...
    fn list_reviewable_hi_ts(
        ...
        MechanicalTurk::list_reviewable_hi_ts(&(**self), input)
    }
    ...
    fn list_worker_blocks(
        ...
        MechanicalTurk::list_worker_blocks(&(**self), input)
    }
    ...
    {
        MechanicalTurk::list_workers_with_qualification_type(&(**self), input)
    }
    ...
    fn notify_workers(
        ...
        MechanicalTurk::notify_workers(&(**self), input)
    }
    ...
    fn reject_assignment(
        ...
        MechanicalTurk::reject_assignment(&(**self), input)
    }
    ...
    fn reject_qualification_request(
        ...
        MechanicalTurk::reject_qualification_request(&(**self), input)
    }
    ...
    fn send_bonus(
        ...
        MechanicalTurk::send_bonus(&(**self), input)
    }
    ...
    fn send_test_event_notification(
        ...
        MechanicalTurk::send_test_event_notification(&(**self), input)
    }
    ...
    fn update_expiration_for_hit(
        ...
        MechanicalTurk::update_expiration_for_hit(&(**self), input)
    }
    ...
    fn update_hit_review_status(
        ...
        MechanicalTurk::update_hit_review_status(&(**self), input)
    }
    ...
    fn update_hit_type_of_hit(
        ...
        MechanicalTurk::update_hit_type_of_hit(&(**self), input)
    }
    ...
    fn update_notification_settings(
        ...
        MechanicalTurk::update_notification_settings(&(**self), input)
    }
    ...
    fn update_qualification_type(
        ...
        MechanicalTurk::update_qualification_type(&(**self), input)
    }
}
