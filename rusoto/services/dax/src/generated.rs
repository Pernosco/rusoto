...
impl<T: ?Sized + DynamodbAccelerator> DynamodbAccelerator for ::std::rc::Rc<T> {
    /// <p>Creates a DAX cluster. All nodes in the cluster run the same DAX caching software.</p>
    fn create_cluster(
        &self,
        input: CreateClusterRequest,
    ) -> RusotoFuture<CreateClusterResponse, CreateClusterError> {
        DynamodbAccelerator::create_cluster(&(**self), input)
    }
    ...
    fn create_parameter_group(
        ...
        DynamodbAccelerator::create_parameter_group(&(**self), input)
    }
    ...
    fn create_subnet_group(
        ...
        DynamodbAccelerator::create_subnet_group(&(**self), input)
    }
    ...
    fn decrease_replication_factor(
        ...
        DynamodbAccelerator::decrease_replication_factor(&(**self), input)
    }
    ...
    fn delete_cluster(
        ...
        DynamodbAccelerator::delete_cluster(&(**self), input)
    }
    ...
    fn delete_parameter_group(
        ...
        DynamodbAccelerator::delete_parameter_group(&(**self), input)
    }
    ...
    fn delete_subnet_group(
        ...
        DynamodbAccelerator::delete_subnet_group(&(**self), input)
    }
    ...
    fn describe_clusters(
        ...
        DynamodbAccelerator::describe_clusters(&(**self), input)
    }
    ...
    fn describe_default_parameters(
        ...
        DynamodbAccelerator::describe_default_parameters(&(**self), input)
    }
    ...
    fn describe_events(
        ...
        DynamodbAccelerator::describe_events(&(**self), input)
    }
    ...
    fn describe_parameter_groups(
        ...
        DynamodbAccelerator::describe_parameter_groups(&(**self), input)
    }
    ...
    fn describe_parameters(
        ...
        DynamodbAccelerator::describe_parameters(&(**self), input)
    }
    ...
    fn describe_subnet_groups(
        ...
        DynamodbAccelerator::describe_subnet_groups(&(**self), input)
    }
    ...
    fn increase_replication_factor(
        ...
        DynamodbAccelerator::increase_replication_factor(&(**self), input)
    }

    /// <p>List all of the tags for a DAX cluster. You can call <code>ListTags</code> up to 10 times per second, per account.</p>
    fn list_tags(&self, input: ListTagsRequest) -> RusotoFuture<ListTagsResponse, ListTagsError> {
        DynamodbAccelerator::list_tags(&(**self), input)
    }
    ...
    fn reboot_node(
        ...
        DynamodbAccelerator::reboot_node(&(**self), input)
    }
    ...
    fn tag_resource(
        ...
        DynamodbAccelerator::tag_resource(&(**self), input)
    }
    ...
    fn untag_resource(
        ...
        DynamodbAccelerator::untag_resource(&(**self), input)
    }
    ...
    fn update_cluster(
        ...
        DynamodbAccelerator::update_cluster(&(**self), input)
    }
    ...
    fn update_parameter_group(
        ...
        DynamodbAccelerator::update_parameter_group(&(**self), input)
    }
    ...
    fn update_subnet_group(
        ...
        DynamodbAccelerator::update_subnet_group(&(**self), input)
    }
}
