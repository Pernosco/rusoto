...
impl<T: ?Sized + ElastiCache> ElastiCache for ::std::rc::Rc<T> {
    /// <p>Adds up to 50 cost allocation tags to the named resource. A cost allocation tag is a key-value pair where the key and value are case-sensitive. You can use cost allocation tags to categorize and track your AWS costs.</p> <p> When you apply tags to your ElastiCache resources, AWS generates a cost allocation report as a comma-separated value (CSV) file with your usage and costs aggregated by your tags. You can apply tags that represent business categories (such as cost centers, application names, or owners) to organize your costs across multiple services. For more information, see <a href="http://docs.aws.amazon.com/AmazonElastiCache/latest/UserGuide/Tagging.html">Using Cost Allocation Tags in Amazon ElastiCache</a> in the <i>ElastiCache User Guide</i>.</p>
    fn add_tags_to_resource(
        &self,
        input: AddTagsToResourceMessage,
    ) -> RusotoFuture<TagListMessage, AddTagsToResourceError> {
        ElastiCache::add_tags_to_resource(&(**self), input)
    }
    ...
    fn authorize_cache_security_group_ingress(
        ...
        AuthorizeCacheSecurityGroupIngressError,
    > {
        ElastiCache::authorize_cache_security_group_ingress(&(**self), input)
    }
    ...
    fn copy_snapshot(
        ...
        ElastiCache::copy_snapshot(&(**self), input)
    }
    ...
    fn create_cache_cluster(
        ...
        ElastiCache::create_cache_cluster(&(**self), input)
    }
    ...
    fn create_cache_parameter_group(
        ...
        ElastiCache::create_cache_parameter_group(&(**self), input)
    }
    ...
    fn create_cache_security_group(
        ...
        ElastiCache::create_cache_security_group(&(**self), input)
    }
    ...
    fn create_cache_subnet_group(
        ...
        ElastiCache::create_cache_subnet_group(&(**self), input)
    }
    ...
    fn create_replication_group(
        ...
        ElastiCache::create_replication_group(&(**self), input)
    }
    ...
    fn create_snapshot(
        ...
        ElastiCache::create_snapshot(&(**self), input)
    }
    ...
    fn delete_cache_cluster(
        ...
        ElastiCache::delete_cache_cluster(&(**self), input)
    }
    ...
    fn delete_cache_parameter_group(
        ...
        ElastiCache::delete_cache_parameter_group(&(**self), input)
    }
    ...
    fn delete_cache_security_group(
        ...
        ElastiCache::delete_cache_security_group(&(**self), input)
    }
    ...
    fn delete_cache_subnet_group(
        ...
        ElastiCache::delete_cache_subnet_group(&(**self), input)
    }
    ...
    fn delete_replication_group(
        ...
        ElastiCache::delete_replication_group(&(**self), input)
    }
    ...
    fn delete_snapshot(
        ...
        ElastiCache::delete_snapshot(&(**self), input)
    }
    ...
    fn describe_cache_clusters(
        ...
        ElastiCache::describe_cache_clusters(&(**self), input)
    }
    ...
    fn describe_cache_engine_versions(
        ...
        ElastiCache::describe_cache_engine_versions(&(**self), input)
    }
    ...
    fn describe_cache_parameter_groups(
        ...
        ElastiCache::describe_cache_parameter_groups(&(**self), input)
    }
    ...
    fn describe_cache_parameters(
        ...
        ElastiCache::describe_cache_parameters(&(**self), input)
    }
    ...
    fn describe_cache_security_groups(
        ...
        ElastiCache::describe_cache_security_groups(&(**self), input)
    }
    ...
    fn describe_cache_subnet_groups(
        ...
        ElastiCache::describe_cache_subnet_groups(&(**self), input)
    }
    ...
    {
        ElastiCache::describe_engine_default_parameters(&(**self), input)
    }
    ...
    fn describe_events(
        ...
        ElastiCache::describe_events(&(**self), input)
    }
    ...
    fn describe_replication_groups(
        ...
        ElastiCache::describe_replication_groups(&(**self), input)
    }
    ...
    fn describe_reserved_cache_nodes(
        ...
        ElastiCache::describe_reserved_cache_nodes(&(**self), input)
    }
    ...
    {
        ElastiCache::describe_reserved_cache_nodes_offerings(&(**self), input)
    }
    ...
    fn describe_snapshots(
        ...
        ElastiCache::describe_snapshots(&(**self), input)
    }
    ...
    {
        ElastiCache::list_allowed_node_type_modifications(&(**self), input)
    }
    ...
    fn list_tags_for_resource(
        ...
        ElastiCache::list_tags_for_resource(&(**self), input)
    }
    ...
    fn modify_cache_cluster(
        ...
        ElastiCache::modify_cache_cluster(&(**self), input)
    }
    ...
    fn modify_cache_parameter_group(
        ...
        ElastiCache::modify_cache_parameter_group(&(**self), input)
    }
    ...
    fn modify_cache_subnet_group(
        ...
        ElastiCache::modify_cache_subnet_group(&(**self), input)
    }
    ...
    fn modify_replication_group(
        ...
        ElastiCache::modify_replication_group(&(**self), input)
    }
    ...
    fn modify_replication_group_shard_configuration(
        ...
        ModifyReplicationGroupShardConfigurationError,
    > {
        ElastiCache::modify_replication_group_shard_configuration(&(**self), input)
    }
    ...
    fn purchase_reserved_cache_nodes_offering(
        ...
        PurchaseReservedCacheNodesOfferingError,
    > {
        ElastiCache::purchase_reserved_cache_nodes_offering(&(**self), input)
    }
    ...
    fn reboot_cache_cluster(
        ...
        ElastiCache::reboot_cache_cluster(&(**self), input)
    }
    ...
    fn remove_tags_from_resource(
        ...
        ElastiCache::remove_tags_from_resource(&(**self), input)
    }
    ...
    fn reset_cache_parameter_group(
        ...
        ElastiCache::reset_cache_parameter_group(&(**self), input)
    }
    ...
    {
        ElastiCache::revoke_cache_security_group_ingress(&(**self), input)
    }
    ...
    fn test_failover(
        ...
        ElastiCache::test_failover(&(**self), input)
    }
}
