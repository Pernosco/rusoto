...
impl<T: ?Sized + Elb> Elb for ::std::rc::Rc<T> {
    /// <p>Adds the specified tags to the specified load balancer. Each load balancer can have a maximum of 10 tags.</p> <p>Each tag consists of a key and an optional value. If a tag with the same key is already associated with the load balancer, <code>AddTags</code> updates its value.</p> <p>For more information, see <a href="http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/add-remove-tags.html">Tag Your Classic Load Balancer</a> in the <i>Classic Load Balancer Guide</i>.</p>
    fn add_tags(&self, input: AddTagsInput) -> RusotoFuture<AddTagsOutput, AddTagsError> {
        Elb::add_tags(&(**self), input)
    }
    ...
    {
        Elb::apply_security_groups_to_load_balancer(&(**self), input)
    }
    ...
    fn attach_load_balancer_to_subnets(
        ...
        Elb::attach_load_balancer_to_subnets(&(**self), input)
    }
    ...
    fn configure_health_check(
        ...
        Elb::configure_health_check(&(**self), input)
    }
    ...
    {
        Elb::create_app_cookie_stickiness_policy(&(**self), input)
    }
    ...
    {
        Elb::create_lb_cookie_stickiness_policy(&(**self), input)
    }
    ...
    fn create_load_balancer(
        ...
        Elb::create_load_balancer(&(**self), input)
    }
    ...
    fn create_load_balancer_listeners(
        ...
        Elb::create_load_balancer_listeners(&(**self), input)
    }
    ...
    fn create_load_balancer_policy(
        ...
        Elb::create_load_balancer_policy(&(**self), input)
    }
    ...
    fn delete_load_balancer(
        ...
        Elb::delete_load_balancer(&(**self), input)
    }
    ...
    fn delete_load_balancer_listeners(
        ...
        Elb::delete_load_balancer_listeners(&(**self), input)
    }
    ...
    fn delete_load_balancer_policy(
        ...
        Elb::delete_load_balancer_policy(&(**self), input)
    }
    ...
    fn deregister_instances_from_load_balancer(
        ...
        Elb::deregister_instances_from_load_balancer(&(**self), input)
    }
    ...
    fn describe_account_limits(
        ...
        Elb::describe_account_limits(&(**self), input)
    }
    ...
    fn describe_instance_health(
        ...
        Elb::describe_instance_health(&(**self), input)
    }
    ...
    {
        Elb::describe_load_balancer_attributes(&(**self), input)
    }
    ...
    fn describe_load_balancer_policies(
        ...
        Elb::describe_load_balancer_policies(&(**self), input)
    }
    ...
    {
        Elb::describe_load_balancer_policy_types(&(**self), input)
    }
    ...
    fn describe_load_balancers(
        ...
        Elb::describe_load_balancers(&(**self), input)
    }
    ...
    fn detach_load_balancer_from_subnets(
        ...
        Elb::detach_load_balancer_from_subnets(&(**self), input)
    }
    ...
    {
        Elb::disable_availability_zones_for_load_balancer(&(**self), input)
    }
    ...
    fn enable_availability_zones_for_load_balancer(
        ...
        Elb::enable_availability_zones_for_load_balancer(&(**self), input)
    }
    ...
    fn modify_load_balancer_attributes(
        ...
        Elb::modify_load_balancer_attributes(&(**self), input)
    }
    ...
    fn register_instances_with_load_balancer(
        ...
        Elb::register_instances_with_load_balancer(&(**self), input)
    }
    ...
    fn set_load_balancer_listener_ssl_certificate(
        ...
        SetLoadBalancerListenerSSLCertificateError,
    > {
        Elb::set_load_balancer_listener_ssl_certificate(&(**self), input)
    }
    ...
    fn set_load_balancer_policies_for_backend_server(
        ...
        SetLoadBalancerPoliciesForBackendServerError,
    > {
        Elb::set_load_balancer_policies_for_backend_server(&(**self), input)
    }
    ...
    {
        Elb::set_load_balancer_policies_of_listener(&(**self), input)
    }
}
