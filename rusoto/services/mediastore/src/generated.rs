...
impl<T: ?Sized + MediaStore> MediaStore for ::std::rc::Rc<T> {
    /// <p>Creates a storage container to hold objects. A container is similar to a bucket in the Amazon S3 service.</p>
    fn create_container(
        &self,
        input: CreateContainerInput,
    ) -> RusotoFuture<CreateContainerOutput, CreateContainerError> {
        MediaStore::create_container(&(**self), input)
    }
    ...
    fn delete_container(
        ...
        MediaStore::delete_container(&(**self), input)
    }
    ...
    fn delete_container_policy(
        ...
        MediaStore::delete_container_policy(&(**self), input)
    }
    ...
    fn delete_cors_policy(
        ...
        MediaStore::delete_cors_policy(&(**self), input)
    }
    ...
    fn describe_container(
        ...
        MediaStore::describe_container(&(**self), input)
    }
    ...
    fn get_container_policy(
        ...
        MediaStore::get_container_policy(&(**self), input)
    }
    ...
    fn get_cors_policy(
        ...
        MediaStore::get_cors_policy(&(**self), input)
    }
    ...
    fn list_containers(
        ...
        MediaStore::list_containers(&(**self), input)
    }
    ...
    fn put_container_policy(
        ...
        MediaStore::put_container_policy(&(**self), input)
    }
    ...
    fn put_cors_policy(
        ...
        MediaStore::put_cors_policy(&(**self), input)
    }
}
