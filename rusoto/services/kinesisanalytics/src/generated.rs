...
impl<T: ?Sized + KinesisAnalytics> KinesisAnalytics for ::std::rc::Rc<T> {
    /// <p>Adds a CloudWatch log stream to monitor application configuration errors. For more information about using CloudWatch log streams with Amazon Kinesis Analytics applications, see <a href="http://docs.aws.amazon.com/kinesisanalytics/latest/dev/cloudwatch-logs.html">Working with Amazon CloudWatch Logs</a>.</p>
    fn add_application_cloud_watch_logging_option(
        &self,
        input: AddApplicationCloudWatchLoggingOptionRequest,
        ...
        AddApplicationCloudWatchLoggingOptionError,
    > {
        KinesisAnalytics::add_application_cloud_watch_logging_option(&(**self), input)
    }
    ...
    fn add_application_input(
        ...
        KinesisAnalytics::add_application_input(&(**self), input)
    }
    ...
    fn add_application_input_processing_configuration(
        ...
        AddApplicationInputProcessingConfigurationError,
    > {
        KinesisAnalytics::add_application_input_processing_configuration(&(**self), input)
    }
    ...
    fn add_application_output(
        ...
        KinesisAnalytics::add_application_output(&(**self), input)
    }
    ...
    fn add_application_reference_data_source(
        ...
        AddApplicationReferenceDataSourceError,
    > {
        KinesisAnalytics::add_application_reference_data_source(&(**self), input)
    }
    ...
    fn create_application(
        ...
        KinesisAnalytics::create_application(&(**self), input)
    }
    ...
    fn delete_application(
        ...
        KinesisAnalytics::delete_application(&(**self), input)
    }
    ...
    fn delete_application_cloud_watch_logging_option(
        ...
        DeleteApplicationCloudWatchLoggingOptionError,
    > {
        KinesisAnalytics::delete_application_cloud_watch_logging_option(&(**self), input)
    }
    ...
    fn delete_application_input_processing_configuration(
        ...
        DeleteApplicationInputProcessingConfigurationError,
    > {
        KinesisAnalytics::delete_application_input_processing_configuration(&(**self), input)
    }
    ...
    fn delete_application_output(
        ...
        KinesisAnalytics::delete_application_output(&(**self), input)
    }
    ...
    fn delete_application_reference_data_source(
        ...
        DeleteApplicationReferenceDataSourceError,
    > {
        KinesisAnalytics::delete_application_reference_data_source(&(**self), input)
    }
    ...
    fn describe_application(
        ...
        KinesisAnalytics::describe_application(&(**self), input)
    }
    ...
    fn discover_input_schema(
        ...
        KinesisAnalytics::discover_input_schema(&(**self), input)
    }
    ...
    fn list_applications(
        ...
        KinesisAnalytics::list_applications(&(**self), input)
    }
    ...
    fn start_application(
        ...
        KinesisAnalytics::start_application(&(**self), input)
    }
    ...
    fn stop_application(
        ...
        KinesisAnalytics::stop_application(&(**self), input)
    }
    ...
    fn update_application(
        ...
        KinesisAnalytics::update_application(&(**self), input)
    }
}
