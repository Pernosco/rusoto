...
/// <p><p>General properties describing a fleet.</p> <p>Fleet-related operations include:</p> <ul> <li> <p> <a>CreateFleet</a> </p> </li> <li> <p> <a>ListFleets</a> </p> </li> <li> <p> <a>DeleteFleet</a> </p> </li> <li> <p>Describe fleets:</p> <ul> <li> <p> <a>DescribeFleetAttributes</a> </p> </li> <li> <p> <a>DescribeFleetCapacity</a> </p> </li> <li> <p> <a>DescribeFleetPortSettings</a> </p> </li> <li> <p> <a>DescribeFleetUtilization</a> </p> </li> <li> <p> <a>DescribeRuntimeConfiguration</a> </p> </li> <li> <p> <a>DescribeEC2InstanceLimits</a> </p> </li> <li> <p> <a>DescribeFleetEvents</a> </p> </li> </ul> </li> <li> <p>Update fleets:</p> <ul> <li> <p> <a>UpdateFleetAttributes</a> </p> </li> <li> <p> <a>UpdateFleetCapacity</a> </p> </li> <li> <p> <a>UpdateFleetPortSettings</a> </p> </li> <li> <p> <a>UpdateRuntimeConfiguration</a> </p> </li> </ul> </li> <li> <p>Manage fleet actions:</p> <ul> <li> <p> <a>StartFleetActions</a> </p> </li> <li> <p> <a>StopFleetActions</a> </p> </li> </ul> </li> </ul></p>
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
...
/// <p><p>Current status of fleet utilization, including the number of game and player sessions being hosted.</p> <p>Fleet-related operations include:</p> <ul> <li> <p> <a>CreateFleet</a> </p> </li> <li> <p> <a>ListFleets</a> </p> </li> <li> <p> <a>DeleteFleet</a> </p> </li> <li> <p>Describe fleets:</p> <ul> <li> <p> <a>DescribeFleetAttributes</a> </p> </li> <li> <p> <a>DescribeFleetCapacity</a> </p> </li> <li> <p> <a>DescribeFleetPortSettings</a> </p> </li> <li> <p> <a>DescribeFleetUtilization</a> </p> </li> <li> <p> <a>DescribeRuntimeConfiguration</a> </p> </li> <li> <p> <a>DescribeEC2InstanceLimits</a> </p> </li> <li> <p> <a>DescribeFleetEvents</a> </p> </li> </ul> </li> <li> <p>Update fleets:</p> <ul> <li> <p> <a>UpdateFleetAttributes</a> </p> </li> <li> <p> <a>UpdateFleetCapacity</a> </p> </li> <li> <p> <a>UpdateFleetPortSettings</a> </p> </li> <li> <p> <a>UpdateRuntimeConfiguration</a> </p> </li> </ul> </li> <li> <p>Manage fleet actions:</p> <ul> <li> <p> <a>StartFleetActions</a> </p> </li> <li> <p> <a>StopFleetActions</a> </p> </li> </ul> </li> </ul></p>
#[derive(Default, Debug, Clone, PartialEq, Deserialize)]
#[cfg_attr(test, derive(Serialize))]
...
/// <p><p>Routing configuration for a fleet alias.</p> <p>Fleet-related operations include:</p> <ul> <li> <p> <a>CreateFleet</a> </p> </li> <li> <p> <a>ListFleets</a> </p> </li> <li> <p> <a>DeleteFleet</a> </p> </li> <li> <p>Describe fleets:</p> <ul> <li> <p> <a>DescribeFleetAttributes</a> </p> </li> <li> <p> <a>DescribeFleetCapacity</a> </p> </li> <li> <p> <a>DescribeFleetPortSettings</a> </p> </li> <li> <p> <a>DescribeFleetUtilization</a> </p> </li> <li> <p> <a>DescribeRuntimeConfiguration</a> </p> </li> <li> <p> <a>DescribeEC2InstanceLimits</a> </p> </li> <li> <p> <a>DescribeFleetEvents</a> </p> </li> </ul> </li> <li> <p>Update fleets:</p> <ul> <li> <p> <a>UpdateFleetAttributes</a> </p> </li> <li> <p> <a>UpdateFleetCapacity</a> </p> </li> <li> <p> <a>UpdateFleetPortSettings</a> </p> </li> <li> <p> <a>UpdateRuntimeConfiguration</a> </p> </li> </ul> </li> <li> <p>Manage fleet actions:</p> <ul> <li> <p> <a>StartFleetActions</a> </p> </li> <li> <p> <a>StopFleetActions</a> </p> </li> </ul> </li> </ul></p>
#[derive(Default, Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// <p><p>Settings for a target-based scaling policy (see <a>ScalingPolicy</a>. A target-based policy tracks a particular fleet metric specifies a target value for the metric. As player usage changes, the policy triggers Amazon GameLift to adjust capacity so that the metric returns to the target value. The target configuration specifies settings as needed for the target based policy, including the target value. </p> <p>Operations related to fleet capacity scaling include:</p> <ul> <li> <p> <a>DescribeFleetCapacity</a> </p> </li> <li> <p> <a>UpdateFleetCapacity</a> </p> </li> <li> <p> <a>DescribeEC2InstanceLimits</a> </p> </li> <li> <p>Manage scaling policies:</p> <ul> <li> <p> <a>PutScalingPolicy</a> (auto-scaling)</p> </li> <li> <p> <a>DescribeScalingPolicies</a> (auto-scaling)</p> </li> <li> <p> <a>DeleteScalingPolicy</a> (auto-scaling)</p> </li> </ul> </li> <li> <p>Manage fleet actions:</p> <ul> <li> <p> <a>StartFleetActions</a> </p> </li> <li> <p> <a>StopFleetActions</a> </p> </li> </ul> </li> </ul></p>
#[derive(Default, Debug, Clone, PartialEq, Serialize, Deserialize)]
...
impl From<CredentialsError> for StartFleetActionsError {
    fn from(err: CredentialsError) -> StartFleetActionsError {
        StartFleetActionsError::Credentials(err)
    }
}
impl From<HttpDispatchError> for StartFleetActionsError {
    fn from(err: HttpDispatchError) -> StartFleetActionsError {
        StartFleetActionsError::HttpDispatch(err)
    }
}
impl From<io::Error> for StartFleetActionsError {
    fn from(err: io::Error) -> StartFleetActionsError {
        StartFleetActionsError::HttpDispatch(HttpDispatchError::from(err))
    }
}
...
impl Error for StartFleetActionsError {
    fn description(&self) -> &str {
        match *self {
            ...
            StartFleetActionsError::Validation(ref cause) => cause,
            StartFleetActionsError::Credentials(ref err) => err.description(),
...
impl From<CredentialsError> for StopFleetActionsError {
    fn from(err: CredentialsError) -> StopFleetActionsError {
        StopFleetActionsError::Credentials(err)
    }
}
impl From<HttpDispatchError> for StopFleetActionsError {
    fn from(err: HttpDispatchError) -> StopFleetActionsError {
        StopFleetActionsError::HttpDispatch(err)
    }
}
impl From<io::Error> for StopFleetActionsError {
    fn from(err: io::Error) -> StopFleetActionsError {
        StopFleetActionsError::HttpDispatch(HttpDispatchError::from(err))
    }
}
...
impl<T: ?Sized + GameLift> GameLift for ::std::rc::Rc<T> {
    /// <p><p>Registers a player&#39;s acceptance or rejection of a proposed FlexMatch match. A matchmaking configuration may require player acceptance; if so, then matches built with that configuration cannot be completed unless all players accept the proposed match within a specified time limit. </p> <p>When FlexMatch builds a match, all the matchmaking tickets involved in the proposed match are placed into status <code>REQUIRES_ACCEPTANCE</code>. This is a trigger for your game to get acceptance from all players in the ticket. Acceptances are only valid for tickets when they are in this status; all other acceptances result in an error.</p> <p>To register acceptance, specify the ticket ID, a response, and one or more players. Once all players have registered acceptance, the matchmaking tickets advance to status <code>PLACING</code>, where a new game session is created for the match. </p> <p>If any player rejects the match, or if acceptances are not received before a specified timeout, the proposed match is dropped. The matchmaking tickets are then handled in one of two ways: For tickets where all players accepted the match, the ticket status is returned to <code>SEARCHING</code> to find a new match. For tickets where one or more players failed to accept the match, the ticket status is set to <code>FAILED</code>, and processing is terminated. A new matchmaking request for these players can be submitted as needed. </p> <p>Matchmaking-related operations include:</p> <ul> <li> <p> <a>StartMatchmaking</a> </p> </li> <li> <p> <a>DescribeMatchmaking</a> </p> </li> <li> <p> <a>StopMatchmaking</a> </p> </li> <li> <p> <a>AcceptMatch</a> </p> </li> <li> <p> <a>StartMatchBackfill</a> </p> </li> </ul></p>
    fn accept_match(
        &self,
        input: AcceptMatchInput,
    ) -> RusotoFuture<AcceptMatchOutput, AcceptMatchError> {
        GameLift::accept_match(&(**self), input)
    }
    ...
    fn create_alias(
        ...
        GameLift::create_alias(&(**self), input)
    }
    ...
    fn create_build(
        ...
        GameLift::create_build(&(**self), input)
    }
    ...
    fn create_fleet(
        ...
        GameLift::create_fleet(&(**self), input)
    }
    ...
    fn create_game_session(
        ...
        GameLift::create_game_session(&(**self), input)
    }
    ...
    fn create_game_session_queue(
        ...
        GameLift::create_game_session_queue(&(**self), input)
    }
    ...
    {
        GameLift::create_matchmaking_configuration(&(**self), input)
    }
    ...
    fn create_matchmaking_rule_set(
        ...
        GameLift::create_matchmaking_rule_set(&(**self), input)
    }
    ...
    fn create_player_session(
        ...
        GameLift::create_player_session(&(**self), input)
    }
    ...
    fn create_player_sessions(
        ...
        GameLift::create_player_sessions(&(**self), input)
    }
    ...
    fn create_vpc_peering_authorization(
        ...
        GameLift::create_vpc_peering_authorization(&(**self), input)
    }
    ...
    fn create_vpc_peering_connection(
        ...
        GameLift::create_vpc_peering_connection(&(**self), input)
    }

    /// <p><p>Deletes an alias. This action removes all record of the alias. Game clients attempting to access a server process using the deleted alias receive an error. To delete an alias, specify the alias ID to be deleted.</p> <p>Alias-related operations include:</p> <ul> <li> <p> <a>CreateAlias</a> </p> </li> <li> <p> <a>ListAliases</a> </p> </li> <li> <p> <a>DescribeAlias</a> </p> </li> <li> <p> <a>UpdateAlias</a> </p> </li> <li> <p> <a>DeleteAlias</a> </p> </li> <li> <p> <a>ResolveAlias</a> </p> </li> </ul></p>
    fn delete_alias(&self, input: DeleteAliasInput) -> RusotoFuture<(), DeleteAliasError> {
        GameLift::delete_alias(&(**self), input)
    }

    /// <p><p>Deletes a build. This action permanently deletes the build record and any uploaded build files.</p> <p>To delete a build, specify its ID. Deleting a build does not affect the status of any active fleets using the build, but you can no longer create new fleets with the deleted build.</p> <p>Build-related operations include:</p> <ul> <li> <p> <a>CreateBuild</a> </p> </li> <li> <p> <a>ListBuilds</a> </p> </li> <li> <p> <a>DescribeBuild</a> </p> </li> <li> <p> <a>UpdateBuild</a> </p> </li> <li> <p> <a>DeleteBuild</a> </p> </li> </ul></p>
    fn delete_build(&self, input: DeleteBuildInput) -> RusotoFuture<(), DeleteBuildError> {
        GameLift::delete_build(&(**self), input)
    }

    /// <p><p>Deletes everything related to a fleet. Before deleting a fleet, you must set the fleet&#39;s desired capacity to zero. See <a>UpdateFleetCapacity</a>.</p> <p>This action removes the fleet&#39;s resources and the fleet record. Once a fleet is deleted, you can no longer use that fleet.</p> <p>Fleet-related operations include:</p> <ul> <li> <p> <a>CreateFleet</a> </p> </li> <li> <p> <a>ListFleets</a> </p> </li> <li> <p> <a>DeleteFleet</a> </p> </li> <li> <p>Describe fleets:</p> <ul> <li> <p> <a>DescribeFleetAttributes</a> </p> </li> <li> <p> <a>DescribeFleetCapacity</a> </p> </li> <li> <p> <a>DescribeFleetPortSettings</a> </p> </li> <li> <p> <a>DescribeFleetUtilization</a> </p> </li> <li> <p> <a>DescribeRuntimeConfiguration</a> </p> </li> <li> <p> <a>DescribeEC2InstanceLimits</a> </p> </li> <li> <p> <a>DescribeFleetEvents</a> </p> </li> </ul> </li> <li> <p>Update fleets:</p> <ul> <li> <p> <a>UpdateFleetAttributes</a> </p> </li> <li> <p> <a>UpdateFleetCapacity</a> </p> </li> <li> <p> <a>UpdateFleetPortSettings</a> </p> </li> <li> <p> <a>UpdateRuntimeConfiguration</a> </p> </li> </ul> </li> <li> <p>Manage fleet actions:</p> <ul> <li> <p> <a>StartFleetActions</a> </p> </li> <li> <p> <a>StopFleetActions</a> </p> </li> </ul> </li> </ul></p>
    fn delete_fleet(&self, input: DeleteFleetInput) -> RusotoFuture<(), DeleteFleetError> {
        GameLift::delete_fleet(&(**self), input)
    }
    ...
    fn delete_game_session_queue(
        ...
        GameLift::delete_game_session_queue(&(**self), input)
    }
    ...
    {
        GameLift::delete_matchmaking_configuration(&(**self), input)
    }
    ...
    fn delete_scaling_policy(
        ...
        GameLift::delete_scaling_policy(&(**self), input)
    }
    ...
    fn delete_vpc_peering_authorization(
        ...
        GameLift::delete_vpc_peering_authorization(&(**self), input)
    }
    ...
    fn delete_vpc_peering_connection(
        ...
        GameLift::delete_vpc_peering_connection(&(**self), input)
    }
    ...
    fn describe_alias(
        ...
        GameLift::describe_alias(&(**self), input)
    }
    ...
    fn describe_build(
        ...
        GameLift::describe_build(&(**self), input)
    }
    ...
    fn describe_ec2_instance_limits(
        ...
        GameLift::describe_ec2_instance_limits(&(**self), input)
    }
    ...
    fn describe_fleet_attributes(
        ...
        GameLift::describe_fleet_attributes(&(**self), input)
    }
    ...
    fn describe_fleet_capacity(
        ...
        GameLift::describe_fleet_capacity(&(**self), input)
    }
    ...
    fn describe_fleet_events(
        ...
        GameLift::describe_fleet_events(&(**self), input)
    }
    ...
    fn describe_fleet_port_settings(
        ...
        GameLift::describe_fleet_port_settings(&(**self), input)
    }
    ...
    fn describe_fleet_utilization(
        ...
        GameLift::describe_fleet_utilization(&(**self), input)
    }
    ...
    fn describe_game_session_details(
        ...
        GameLift::describe_game_session_details(&(**self), input)
    }
    ...
    fn describe_game_session_placement(
        ...
        GameLift::describe_game_session_placement(&(**self), input)
    }
    ...
    fn describe_game_session_queues(
        ...
        GameLift::describe_game_session_queues(&(**self), input)
    }
    ...
    fn describe_game_sessions(
        ...
        GameLift::describe_game_sessions(&(**self), input)
    }
    ...
    fn describe_instances(
        ...
        GameLift::describe_instances(&(**self), input)
    }
    ...
    fn describe_matchmaking(
        ...
        GameLift::describe_matchmaking(&(**self), input)
    }
    ...
    {
        GameLift::describe_matchmaking_configurations(&(**self), input)
    }
    ...
    fn describe_matchmaking_rule_sets(
        ...
        GameLift::describe_matchmaking_rule_sets(&(**self), input)
    }
    ...
    fn describe_player_sessions(
        ...
        GameLift::describe_player_sessions(&(**self), input)
    }
    ...
    fn describe_runtime_configuration(
        ...
        GameLift::describe_runtime_configuration(&(**self), input)
    }
    ...
    fn describe_scaling_policies(
        ...
        GameLift::describe_scaling_policies(&(**self), input)
    }
    ...
    {
        GameLift::describe_vpc_peering_authorizations(&(**self))
    }
    ...
    fn describe_vpc_peering_connections(
        ...
        GameLift::describe_vpc_peering_connections(&(**self), input)
    }
    ...
    fn get_game_session_log_url(
        ...
        GameLift::get_game_session_log_url(&(**self), input)
    }
    ...
    fn get_instance_access(
        ...
        GameLift::get_instance_access(&(**self), input)
    }
    ...
    fn list_aliases(
        ...
        GameLift::list_aliases(&(**self), input)
    }
    ...
    fn list_builds(
        ...
        GameLift::list_builds(&(**self), input)
    }
    ...
    fn list_fleets(
        ...
        GameLift::list_fleets(&(**self), input)
    }
    ...
    fn put_scaling_policy(
        ...
        GameLift::put_scaling_policy(&(**self), input)
    }
    ...
    fn request_upload_credentials(
        ...
        GameLift::request_upload_credentials(&(**self), input)
    }
    ...
    fn resolve_alias(
        ...
        GameLift::resolve_alias(&(**self), input)
    }
    ...
    fn search_game_sessions(
        ...
        GameLift::search_game_sessions(&(**self), input)
    }
    ...
    fn start_fleet_actions(
        ...
        GameLift::start_fleet_actions(&(**self), input)
    }
    ...
    fn start_game_session_placement(
        ...
        GameLift::start_game_session_placement(&(**self), input)
    }
    ...
    fn start_match_backfill(
        ...
        GameLift::start_match_backfill(&(**self), input)
    }
    ...
    fn start_matchmaking(
        ...
        GameLift::start_matchmaking(&(**self), input)
    }
    ...
    fn stop_fleet_actions(
        ...
        GameLift::stop_fleet_actions(&(**self), input)
    }
    ...
    fn stop_game_session_placement(
        ...
        GameLift::stop_game_session_placement(&(**self), input)
    }
    ...
    fn stop_matchmaking(
        ...
        GameLift::stop_matchmaking(&(**self), input)
    }
    ...
    fn update_alias(
        ...
        GameLift::update_alias(&(**self), input)
    }
    ...
    fn update_build(
        ...
        GameLift::update_build(&(**self), input)
    }
    ...
    fn update_fleet_attributes(
        ...
        GameLift::update_fleet_attributes(&(**self), input)
    }
    ...
    fn update_fleet_capacity(
        ...
        GameLift::update_fleet_capacity(&(**self), input)
    }
    ...
    fn update_fleet_port_settings(
        ...
        GameLift::update_fleet_port_settings(&(**self), input)
    }
    ...
    fn update_game_session(
        ...
        GameLift::update_game_session(&(**self), input)
    }
    ...
    fn update_game_session_queue(
        ...
        GameLift::update_game_session_queue(&(**self), input)
    }
    ...
    {
        GameLift::update_matchmaking_configuration(&(**self), input)
    }
    ...
    fn update_runtime_configuration(
        ...
        GameLift::update_runtime_configuration(&(**self), input)
    }
    ...
    fn validate_matchmaking_rule_set(
        ...
        GameLift::validate_matchmaking_rule_set(&(**self), input)
    }
}
